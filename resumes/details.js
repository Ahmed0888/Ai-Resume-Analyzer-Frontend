...
function loadResumeDetails() {
    ...
    if (matchScoreEl) matchScoreEl.textContent = (currentResume.matchPercentage || 0).toFixed(0) + '%';
    ...
    if (originalResumeEl) originalResumeEl.textContent = currentResume.originalText || 'No original text available';
    if (improvedResumeEl) improvedResumeEl.textContent = currentResume.aiImprovedText || 'No improved text available';
